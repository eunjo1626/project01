...
const About = () => {
  return (
      ...
      <section className={styles['about-content']}>
        <h2 className={styles.typing} style={{animationDelay:"3s"}}>우리의 이야기</h2>
        ...
        <h2 className={styles.typing} style={{animationDelay:"7s"}}>우리의 철학</h2>
        <p className={styles.fadeIn} style={{animationDelay:"8s"}}>
          우리는 단순히 상품을 판매하지 않습니다.<br />
          계절의 변화 속에서 느껴지는 감정과 분위기를 함께 나누고자 합니다.<br />
          당신의 하루에 어울리는 계절의 색을 더하는 것이 OnGi의 역할입니다.
        </p>

        <h2 className={styles.typing} style={{animationDelay:"10s"}}>Contact</h2>
        <p className={styles.fadeIn} style={{animationDelay:"11s"}}>문의: contact@ongi.co.kr</p>
      </section>
    </div>
